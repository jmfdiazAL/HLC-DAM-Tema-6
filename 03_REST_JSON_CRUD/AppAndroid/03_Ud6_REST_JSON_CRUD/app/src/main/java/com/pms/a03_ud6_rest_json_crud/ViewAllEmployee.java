...
public class ViewAllEmployee extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    /**
     * Método que muestra todos los empleados obtenidos del vector JSON en un ListView
     */
    private void showEmployee(){
        ...
        try {
            ...
            // recorre el vector JSON de todos los empleados
            for(int i = 0; i<result.length(); i++){
                // obtiene el objeto JSON de la posición i del vector
                ...
                // Crea un nuevo objeto HashMap
                HashMap<String,String> employees = new HashMap<>();
                // añadir al HashMap employees la clave/valor => id/valor
                employees.put(Config.TAG_ID,id);
                // añade al HashMap employees la clave/valor => name/valor
                employees.put(Config.TAG_NAME,name);
                // añade el HashMap del empleado al ArrayList
                list.add(employees);
            }
        ...
        // Crea el adaptador del ListView que contendrá el id y el nombre del empleado
        ListAdapter adapter = new SimpleAdapter(
                ViewAllEmployee.this, list, R.layout.list_item,
                new String[]{Config.TAG_ID,Config.TAG_NAME},
                new int[]{R.id.id, R.id.name});

        // Establece el adaptador anterior en el ListView
        listView.setAdapter(adapter);

    } // fin ShowEmployee

    /**
     * Obtiene el vector JSON de todos los empleados
     */
    ...
    /**
     * Método que indica el comportamiento al hacer un click en un elemento del LisView
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        // Lanza la actividad del Intent => ViewEmployee
