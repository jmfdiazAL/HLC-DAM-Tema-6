...
public class ViewEmployee extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Guarda el id del empleado con el que se lanzó esta actividad con el intent
        ...
        //asigna el id del empleado con el que se lanzó la Activity
    ...
    /**
     * Método que obtiene un empleado de la BD
     */
    ...
    /**
     * Método que actúa según el botón sobre el que se hace click
    ...
    /**
     * Método que muestra los datos del empleado actualizando los valores de los EditText
     * @param json: cadena JSON con datos delempleado a mostrar
     */
    ...
    /**
     * Método para eliminar al empleado actual de la BD
     */
     ...
     * al empleado actual. En caso de que confirmación 'Yes' => lo borra de la BD
     */
    private void confirmDeleteEmployee(){
        // Definir el cuadro de diálogo
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
        alertDialogBuilder.setMessage("Are you sure you want to delete the employee?");
